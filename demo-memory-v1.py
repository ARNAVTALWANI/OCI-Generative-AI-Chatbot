...
#Step 6 - here we print all the messages in the memory
...
#Step 8 - here we print all the messages in the memory again and see that our last question and response is printed.
print(memory.chat_memory.messages)
print(summary_memory.chat_memory.messages)
print("Summary of the conversation is-->"+summary_memory.buffer)
